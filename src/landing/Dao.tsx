  ...
  return (
    <div className="grid grid-cols-1 p-4 lg:grid-cols-2 gap-2">
      ...
      <div className="flex flex-col h-full items-center justify-between gap-4 p-2 xl:text-xl">
        <div className="flex flex-col bg-radial-secondary-shade-opposite rounded-md p-2">
        ...
        <div className="flex flex-col text-center bg-radial-secondary-shade p-2 rounded-md">
